...
String test1 = "^>v<"
String test2 = "^v^v^v^v^v"

def map1 = travel(test1)
def map2 = travel(test2)
def santaMap = travel(input)

println(travel("<").size())
println(map1.size())
println(map2.size())
println(santaMap.size())

public def LinkedHashMap<String, Integer> travel(String input) {
    //   println input
    def x = 0
    def y = 0
    def travelMap = [:]
